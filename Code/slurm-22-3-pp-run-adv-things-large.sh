#!/bin/bash
#SBATCH --job-name=adv-things-large
#SBATCH --output=../Data/things/slurm_files/adv-things-v4-outputs-v4_%a.txt
#SBATCH --error=../Data/things/slurm_files/adv-things-v4-errors-v4_%a.txt
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
notebook_name='180-refac-3-adversarial-THINGS-large'
...
outname=${ofdir}/DeepCor-things-idx-${SLURM_ARRAY_TASK_ID}-large
echo $outname
