...
notebook_name='075-DeepCorr-gamma.ipynb'
outdir=../Data/040-DeepCor-Papermill/pp-notebooks-v2_1_0--linear-200-epochs
analysis_name='linear-200-epochs'
...
do
    ...
    outname=${outdir}/075-DeepCorr-gamma-S${SLURM_ARRAY_TASK_ID}-R2-$rep.ipynb
    echo $notebook_name
