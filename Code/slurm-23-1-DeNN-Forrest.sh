#!/bin/bash
#SBATCH --job-name=DeNN
#SBATCH --output=../Data/StudyForrest/ensembles_last_CVAE/slurm_files/DeNN-forrest-v1-outputs-_%a.txt
#SBATCH --error=../Data/StudyForrest/ensembles_last_CVAE/slurm_files/DeNN-forrest-v1-errors-_%a.txt
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
notebook_name='191-DeNN-Forrest.ipynb'
