function m010_func_fist_level(subID,rID)
...
% Set analysis dir
analysis_dir = fullfile('../analyses_SPM',sprintf('preproc_%i',rID),subID)
...
%data_fn = sprintf('/mmfs1/data/aglinska/BC-ABCD-denoise/Data/020-fmriprepped/%s/ses-baselineYear1Arm1/func/s8_%s_ses-baselineYear1Arm1_task-nback_run-0%i_space-MNI152NLin2009cAsym_res-2_desc-preproc_bold.nii',subID,subID,rID);
...
%data_fn = sprintf('/mmfs1/data/aglinska/BC-ABCD-denoise/Data/020-fmriprepped/%s/ses-baselineYear1Arm1/func/s8_%s_ses-baselineYear1Arm1_task-nback_run-0%i_space-MNI152NLin2009cAsym_res-2_desc-COMPCORR_bold.nii',subID,subID,rID);
...
%data_fn = sprintf('/mmfs1/data/aglinska/BC-ABCD-denoise/Data/020-fmriprepped/%s/ses-baselineYear1Arm1/func/s8_%s_ses-baselineYear1Arm1_task-nback_run-0%i_space-MNI152NLin2009cAsym_res-2_desc-DEEPCOR_bold.nii',subID,subID,rID);
