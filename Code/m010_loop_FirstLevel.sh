...
prefixs=(preproc COMPCORR DEEPCOR-TG-1 DEEPCOR-BG-1 DEEPCOR-FG-1)
...
do
    ...
    do
        ...
        epi_path=/mmfs1/data/aglinska/BC-ABCD-denoise/Data/020-fmriprepped/${subID}/ses-baselineYear1Arm1/func/${subID}_ses-baselineYear1Arm1_task-nback_run-0${rID}_space-MNI152NLin2009cAsym_res-2_desc-${prefix}_bold.nii
        analysis_dir=../analyses_SPM/${prefix}_${rID}/${subID}
