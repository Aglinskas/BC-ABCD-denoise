#!/bin/bash
#SBATCH --job-name=papermill-refactored-ABCD-deepcor-v4
#SBATCH --output=../Data/StudyForrest/DeepCor-slurm/papermill-refactored-ABCD-deepcor-v1-outputs-_%a.txt
#SBATCH --error=../Data/StudyForrest/DeepCor-slurm/papermill-refactored-ABCD-deepcor-v1-errors-_%a.txt
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
outname=${ofdir}/$notebook_name-S${SLURM_ARRAY_TASK_ID}-R1.ipynb
echo $outname
...
outname=${ofdir}/$notebook_name-S${SLURM_ARRAY_TASK_ID}-R2.ipynb
echo $outname
